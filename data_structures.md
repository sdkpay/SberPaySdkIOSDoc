...
|completion|SPaymentResult||Да|Блок, отрабатыващий после завершения работы SDK. Структура [SPaymentResult](https://sdkpay.github.io/SberPaySdkIOSDoc/data_structures#spaymentresult)|
